      ...
      <div className="hospital-container relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center py-16 md:py-24">
          ...
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium mb-6 animate-slide-in reveal">
              <span className="w-2 h-2 bg-primary rounded-full pulse-element" />
              Trusted by 50,000+ Patients
            </div>
            
            <h1 className="section-title text-4xl md:text-5xl lg:text-6xl !leading-tight animate-slide-in-delay-1 reveal">
              Your Health Is Our
              <span className="text-gradient block">Top Priority</span>
            </h1>
            
            <p className="text-lg md:text-xl text-muted-foreground mt-6 max-w-xl mx-auto lg:mx-0 animate-slide-in-delay-2 reveal">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8 justify-center lg:justify-start animate-slide-in-delay-3 reveal">
            ...
            <div className="flex flex-wrap gap-4 mt-10 justify-center lg:justify-start">
              {features.map((feature, index) => (
                <div 
                  key={index} 
                  className="flex items-center gap-2 bg-card px-4 py-2 rounded-full shadow-sm reveal"
                >
          ...
          <div className="relative hidden lg:block">
            <div className="relative z-10">
              ...
              <div className="absolute -bottom-6 -left-6 bg-card rounded-2xl p-4 shadow-lg animate-slide-in-delay-2 reveal">
              ...
              <div className="absolute -top-6 -right-6 bg-card rounded-2xl p-4 shadow-lg animate-slide-in-delay-3 reveal">
                <div className="flex items-center gap-3">
